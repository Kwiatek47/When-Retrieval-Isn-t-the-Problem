...
eval-self-consistency-pubmedqa:
	$(PY) scripts/agents/evaluate_self_consistency_pubmedqa.py \
		--dataset data/benchmarks/pubmedqa/official_pqal_test/quick/balanced90.json \
		--backend mock \
		--samples 5 \
		--label self_consistency_balanced90_mock_n5
